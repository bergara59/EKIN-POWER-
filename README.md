...
|----------------|--------------------------------------------------|
| `index.html`   | El contenido y los textos de la página.          |
| `styles.css`   | Los colores, tipografías y el diseño.            |
...
Solo abre `index.html` con doble clic (se abre en el navegador).

## Publicar en internet

Ver los pasos de GitHub + Vercel que te indicó el asistente.
